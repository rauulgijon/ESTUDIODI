using minihitodefinitivo.forms;
...
namespace minihitodefinitivo
{
    public partial class MainWindow : Window
    {
        ...
        private bool informeCargado = false;
        ...
        public MainWindow()
        {
            ...
            visor.IsVisibleChanged += Visor_IsVisibleChanged;
        }
        ...
        private void BtnAñadirModificar_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                MessageBox.Show($"Grupo '{nombreGrupo}' guardado correctamente con {lstAlumnosSeleccionados.Count} alumno(s)", "Éxito", MessageBoxButton.OK, MessageBoxImage.Information);
        ...
        private void BtnEliminar_Click(object sender, RoutedEventArgs e)
        {
            if (grupoSeleccionado == null)
            {
                MessageBox.Show("Selecciona un grupo de la lista inferior para eliminarlo.", "Aviso", MessageBoxButton.OK, MessageBoxImage.Information);
                return;
            }
        ...
        private void NavParticipantes_Click(object sender, RoutedEventArgs e) { MainTabControl.SelectedIndex = 0; }
        private void NavGrupos_Click(object sender, RoutedEventArgs e) { MainTabControl.SelectedIndex = 1; }
        private void NavEmpresas_Click(object sender, RoutedEventArgs e) { MainTabControl.SelectedIndex = 2; }
        private void NavTalent_Lab_Click(object sender, RoutedEventArgs e) { MainTabControl.SelectedIndex = 4; }
        private void NavRetos_Click(object sender, RoutedEventArgs e) { MainTabControl.SelectedIndex = 3; }
        private void NavInformes_Click(object sender, RoutedEventArgs e) { MainTabControl.SelectedIndex = 5; }
        ...
        private async void Visor_IsVisibleChanged(object sender, DependencyPropertyChangedEventArgs e)
        {
            if (visor.IsVisible && !informeCargado)
            {
